...
import { parseArgs, printHelp } from './core/args.js';
import { loadDatasets } from './dataset/load.js';
import { analyzeDatasets } from './dataset/analyze.js';
import { generateBasePage, generateDashboardPage, generateLoginPage, generateProfilePage, generateRegisterPage, generateResourcePage } from './generate/pages.js';
import { generateAuthSetupSpec, generateAuthSpec, generateProfileSpec, generateResourceSpec } from './generate/specs.js';
import { generateFixtures } from './generate/fixtures.js';
import { generatePlaywrightConfig, generatePackageJson, generateTsConfig } from './generate/config.js';
...
function defaultOutputDir(): string {
  return path.resolve(process.cwd(), 'playwright-tests');
}
